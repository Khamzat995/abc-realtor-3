          ...
          <section className="content">
            ...
            <p className="desc">
              ...
              }
              {
                ...
                <>{t('product-description-31')}</>
              }
              {
                description === "description_qadraj" &&
                <>{t('product-description-32')}</>
              }
              {
                description === "description_vadi_evleri" &&
                <>{t('product-description-33')}</>
              }
              {
              ...
              }
              {
                ...
                <>{t('product-description-48')}</>
              }
              {
                description === "description_ertas" &&
                <>{t('product-description-49')}</>
              }
              {
                description === "description_ramada_hotel" &&
                <>{t('product-description-50')}</>
              }
            </p>
            <p className="info">
