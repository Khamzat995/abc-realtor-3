          ...
          <article key={_id}>
            ...
            <div>
              ...
              <p>
                ...
                {
                  description === "description_qadraj" &&
                  <>{t('product-description-32').substring(0, 150)}</>
                }
                {
                  description === "description_vadi_evleri" &&
                  <>{t('product-description-33').substring(0, 150)}</>
                }
                {
                ...
                {
                  description === "description_avrupa_camlı" &&
                  <>{t('product-description-43').substring(0, 150)}</>
                }
                {
                ...
                {
                  description === "description_nefes_gokturk" &&
                  <>{t('product-description-48').substring(0, 150)}</>
                }
                {
                  description === "description_ertas" &&
                  <>{t('product-description-49').substring(0, 150)}</>
                }
                {
                  description === "description_ramada_hotel" &&
                  <>{t('product-description-50').substring(0, 150)}</>
                }
                ...</p>
